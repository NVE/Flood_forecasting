...
It is however open to the public and can slow down during periods of intense use. It also does not allow plotting multiple model results at once.
 ...
 * Selection of a single station based on region number, main number, clicking on map
