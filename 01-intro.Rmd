...
subset2plot_m2 <- dplyr::filter(model_2, nbname %in% station & Type == "Runoff" & Variable %in% variable_2) 
subset2plot_m3 <- dplyr::filter(model_3, nbname %in% station & Type == "Runoff" & Variable %in% variable_3) 
# subset2plot_m1 <- dplyr::filter(model_1, nbname %in% station & Type == "Runoff" & Variable %in% variable_1)             
