...
alldat <- read.table("E:\\SHINY\\NVE\\DDM\\ML\\Allstationsallmodels.csv", header = TRUE, skip = 0, as.is=TRUE,sep = ",")
allmeas <- read.table("E:\\SHINY\\NVE\\DDM\\ML\\allmodelsperformancemeasures.csv", header = TRUE, skip = 0, sep = ",")
